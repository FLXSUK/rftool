...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/uk/co/flxs/rftool/App.class`
...
--name RFTool \
--main-class uk.co.flxs.rftool.AppLauncher \
--main-jar ${MAIN_JAR} \
--java-options -Xmx2048m \
--runtime-image target/java-runtime \
--icon src/main/resources/uk/co/flxs/rftool/icon.png \
--app-version ${APP_VERSION} \
--vendor "FLXS" \
--copyright "Copyright © 2019-21 FLXS" \
--mac-package-identifier uk.co.flxs.rftool \
--mac-package-name RFTool